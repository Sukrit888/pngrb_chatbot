...
st.caption("Streamlit Cloud–only RAG using OpenAI")
...
OPENAI_MODEL = "gpt-4o-mini"  # fast, cheap, reliable
...
# --------------------------------------------------
# VECTOR STORE (LIGHTWEIGHT & CLOUD SAFE)
# --------------------------------------------------
@st.cache_resource
...
if query:
    ...
    system_prompt = (
        "You are a regulatory assistant for PNGRB. "
