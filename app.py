...
st.caption("Streamlit Cloud RAG using OpenAI (Stable Version)")
...
if uploaded_files:
    for f in uploaded_files:
        with open(os.path.join(DATA_DIR, f.name), "wb") as out:
            out.write(f.read())
    st.sidebar.success("Files uploaded. FAISS will rebuild if needed.")

# --------------------------------------------------
# VECTOR STORE (SAFE + AUTO-REBUILD)
# --------------------------------------------------
@st.cache_resource
